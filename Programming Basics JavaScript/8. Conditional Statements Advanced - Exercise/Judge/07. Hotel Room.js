  ...
  switch (month) {
    ...
    case "October":
      ...
      if (nights > 7 && nights <= 14) {
        ...
        priceStudioPerNight -= priceStudioPerNight * 0.3;
      }
      break;
    case "June":
    case "September":
      ...
      if (nights > 14) {
        priceStudioPerNight -= priceStudioPerNight * 0.2;
      }
      break;
    case "July":
    case "August":
